...
const CITIES = [
  {
    ...
    flightNote: "Australia's biggest international hub — direct flights to all NZ main centres, the USA, Asia and the Pacific; Europe one-stop.",
    ...
    socialNote: "Big, fast and international — huge dining, nightlife and events scene, but it takes effort to build a village."
  },
  {
    ...
    flightNote: "Second-largest hub — direct to NZ, Asia and the USA; Europe and most Pacific islands one-stop.",
  ...
  },
  {
    ...
    economy: "Resources powerhouse — mining, energy and engineering wages lead the country.",
  ...
  },
  {
    ...
    hobbyHighlights: { food: "Barossa and McLaren Vale wine regions under an hour away", arts: "Adelaide Festival and Fringe — world's second-largest fringe" },
    social: { buzz: .55, balanced: .85, quiet: .75 },
    socialNote: "Compact, affordable and easy-going — 20 minutes to anywhere, but a smaller Kiwi community."
  },
  {
    ...
    hobbyHighlights: { surf: "World-class points — Snapper, Burleigh, Kirra", hike: "Lamington and Springbrook rainforest in the hinterland" },
    social: { buzz: .6, balanced: .8, quiet: .6 },
    socialNote: "The unofficial Kiwi capital of Australia — the highest NZ-born share of any Australian city."
  },
  {
    id: "canberra", name: "Canberra", state: "ACT",
    population: 470000, nzBorn: 7000, rent: 620,
    economy: "Government town — the public service, policy, defence and government IT dominate.",
  ...
  },
  {
    ...
    climate: "Tropical — hot year-round (~32°C), a humid wet season Nov–Apr and a glorious dry season.",
    flights: { nz: .1, asia: .8, europe: .3, usa: .1, pacific: .1 },
    flightNote: "Closer to Bali and Singapore than to Sydney — direct Asian routes, but no NZ flights.",
    hobbies: { surf: .1, hike: .7, arts: .5, music: .5, sport: .5, food: .6, dive: .5, camp: .9, snow: 0 },
    hobbyHighlights: { camp: "Kakadu and Litchfield national parks within two hours", surf: "Swimming and surf limited — crocodiles and stingers are real" },
  ...
  },
  {
    ...
    hobbyHighlights: { surf: "City beaches with genuine surf culture — Merewether is a national reserve" },
    social: { buzz: .55, balanced: .85, quiet: .75 },
  ...
  },
  {
    ...
    economy: "Tourism capital of the tropics — the Great Barrier Reef and Daintree drive the economy.",
